  ...
  return (
    <>
      <section className="other-admission-scope" aria-labelledby="other-scope-title">
        ...
        <p>
          ...
          <a
            ...
            target="_blank"
          >
            甄選委員會 115 申請入學官方總表的 <strong>64 所學校</strong>
          </a>
      ...
      <aside className="other-admission-warning">
        此頁只提供官方招生入口，不把不同制度的門檻硬套進 CAC 64 校回測。法鼓文理學院、臺灣戲曲學院與兩所空中大學不適用 CAC 學測回測；臺灣警察專科學校 114 招收二年制專科警員班，非學士班且不採學測。軍事、警政或其他特殊招生也可能另有資格、體檢、口試、體能或專業項目，請以各校當年度官方簡章為準。
      </aside>
    </>
  );
}
